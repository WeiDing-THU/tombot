...
class MoveJ {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    if (obj.joint.length !== 7) {
      throw new Error('Unable to serialize array field joint - length must be 7')
    }
    // Serialize message field [joint]
    bufferOffset = _arraySerializer.float32(obj.joint, buffer, bufferOffset, 7);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.joint = _arrayDeserializer.float32(buffer, bufferOffset, 7)
  ...
  static Resolve(msg) {
    ...
    if (msg.joint !== undefined) {
      ...
      resolved.joint = new Array(7).fill(0)
    }
