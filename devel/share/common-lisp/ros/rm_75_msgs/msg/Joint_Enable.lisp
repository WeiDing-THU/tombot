...
(cl:defmethod cl:initialize-instance :after ((m <Joint_Enable>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Joint_Enable)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rm_75_msgs-msg:<Joint_Enable> is deprecated: use rm_75_msgs-msg:Joint_Enable instead.")))

(cl:ensure-generic-function 'joint_num-val :lambda-list '(m))
(cl:defmethod joint_num-val ((m <Joint_Enable>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rm_75_msgs-msg:joint_num-val is deprecated.  Use rm_75_msgs-msg:joint_num instead.")
  (joint_num m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Joint_Enable>)))
  ...
  (cl:format cl:nil "#对指定关节进行使能操作~%uint8 joint_num     #对应关节序号，从基座到机械臂手爪端，序号依次为1～7~%bool state          #true-上使能，false-掉使能~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Joint_Enable)))
  "Returns full string definition for message of type 'Joint_Enable"
  (cl:format cl:nil "#对指定关节进行使能操作~%uint8 joint_num     #对应关节序号，从基座到机械臂手爪端，序号依次为1～7~%bool state          #true-上使能，false-掉使能~%~%~%"))
