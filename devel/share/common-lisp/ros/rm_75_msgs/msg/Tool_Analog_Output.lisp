...
(cl:defmethod cl:initialize-instance :after ((m <Tool_Analog_Output>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Tool_Analog_Output)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rm_75_msgs-msg:<Tool_Analog_Output> is deprecated: use rm_75_msgs-msg:Tool_Analog_Output instead.")))

(cl:ensure-generic-function 'voltage-val :lambda-list '(m))
(cl:defmethod voltage-val ((m <Tool_Analog_Output>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rm_75_msgs-msg:voltage-val is deprecated.  Use rm_75_msgs-msg:voltage instead.")
  (voltage m))
