...
(cl:defmethod cl:initialize-instance :after ((m <MoveL>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveL)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rm_75_msgs-msg:<MoveL> is deprecated: use rm_75_msgs-msg:MoveL instead.")))

(cl:ensure-generic-function 'Pose-val :lambda-list '(m))
(cl:defmethod Pose-val ((m <MoveL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rm_75_msgs-msg:Pose-val is deprecated.  Use rm_75_msgs-msg:Pose instead.")
  (Pose m))
