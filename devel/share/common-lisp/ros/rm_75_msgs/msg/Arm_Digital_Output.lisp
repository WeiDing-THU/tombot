...
(cl:defmethod cl:initialize-instance :after ((m <Arm_Digital_Output>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Arm_Digital_Output)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rm_75_msgs-msg:<Arm_Digital_Output> is deprecated: use rm_75_msgs-msg:Arm_Digital_Output instead.")))
