...
(cl:defmethod cl:initialize-instance :after ((m <Arm_Analog_Output>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Arm_Analog_Output)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rm_75_msgs-msg:<Arm_Analog_Output> is deprecated: use rm_75_msgs-msg:Arm_Analog_Output instead.")))
