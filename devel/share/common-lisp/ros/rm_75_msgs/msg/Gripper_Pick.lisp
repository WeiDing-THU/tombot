...
(cl:defmethod cl:initialize-instance :after ((m <Gripper_Pick>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Gripper_Pick)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rm_75_msgs-msg:<Gripper_Pick> is deprecated: use rm_75_msgs-msg:Gripper_Pick instead.")))
...
(cl:defmethod force-val ((m <Gripper_Pick>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rm_75_msgs-msg:force-val is deprecated.  Use rm_75_msgs-msg:force instead.")
  (force m))
